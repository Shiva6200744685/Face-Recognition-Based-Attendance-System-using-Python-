...
class Student:
     def __init__(self,root):
         ...
         # third image 
          ...
          save_btn.grid(row=0,column=0)  #command=self.add_data

          update_btn=Button(btn_frame,text="Update",width=15,font=("times new roman",13,"bold"),bg="blue",fg="white")
          update_btn.grid(row=0,column=1)#,command=self.update_data
          ...
          reset_btn.grid(row=0,column=3) #,command=self.reset_data
          ...
          take_photo_btn.grid(row=0,column=0) #command=self.add_data
